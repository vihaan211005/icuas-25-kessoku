...
static utils::sharedQueue<Eigen::Vector4d>* consumerQueue;

class Planner {
public:
    Planner(octomap::OcTree* tree, Bounds b, rclcpp::Logger logger, utils::sharedQueue<Eigen::Vector4d>* queue) : 
        bounds_(b), 
        logger_(logger)
    {
        consumerQueue = queue;
